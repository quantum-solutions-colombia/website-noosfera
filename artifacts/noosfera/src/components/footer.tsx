          ...
          >
            {(["facebook", "instagram", "tiktok", "whatsapp"] as const).map((network) => (
              <motion.a
                key={network}
                href={
                  network === "facebook" ? "https://facebook.com/noosfera"
                  : network === "instagram" ? "https://instagram.com/noosfera"
                  : network === "tiktok" ? "https://tiktok.com/@noosfera"
                ...
                animate={{ backgroundColor: activeNetwork === network ? BRAND[network] : DEFAULT }}
